...
s.linkInternalFilters = "javascript:,carmax.com,carmax.org";
...
function s_doPlugins(s) {
   if (!s.campaign) {
      s.campaign = s.getQueryParam('adcode,sc_cid', ':');
      s.campaign = s.getValOnce(s.campaign, "s_camp", 0);
   }
   var s_temp_tc = s.getAndPersistValue(s.campaign, 's_cp_persist', 7);
   
   if (s_temp_tc && s.pageName) s.prop39 = s_temp_tc + ":" + s.pageName;
   
   if (!s.eVar18) {
      s.eVar18 = s.getQueryParam('intcmp');
   ...
   if (s.prop16 && !s.eVar24) s.eVar24 = s.prop16;
   if (s.prop17 && !s.eVar25) s.eVar25 = s.prop17;
   if (s.prop19 && !s.eVar26) s.eVar26 = s.prop19;
   if (s.prop20 && !s.eVar27) s.eVar27 = s.prop20;
   if (s.prop21 && !s.eVar28) s.eVar28 = s.prop21;
   if (s.prop22 && !s.eVar29) s.eVar29 = s.prop22;
   if (s.prop23 && !s.eVar32) s.eVar32 = s.prop23;
   if (s.prop24 && !s.eVar33) s.eVar33 = s.prop24;
   if (s.prop15 && !s.eVar35) s.eVar35 = s.prop15;
   if (s.prop30 && !s.eVar46) s.eVar46 = s.prop30;
   ...
   if (s.prop11) {
      ...
      if (t_search) {
         ...
         if (!s.prop29) s.prop29 = s_searchPage;
         s.eVar47 = s.getActionDepth("s_depth");
      }
   }
   if (s.prop29 && !s.eVar45) s.eVar45 = s.prop29;
   s.prop31 = s.getVisitStart("s_visit");
}
...
s.visitorNamespace="jatai";
s.trackingServer="n.jatai.net";
s.trackingServerSecure="o.jatai.net";
s.dc=122;
