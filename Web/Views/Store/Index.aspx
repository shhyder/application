...
<table width="100%">
    ...
    <div id="StoreList" >
     ...
     function GetList(page) {
         ...
         lastpage = page;
         jQuery.ajax({
             url: "<%= Web.Model.Utility.Get_Path() %>/Store/GetList/" + page,
             dataType: 'json',
             type: "POST",
             data: queryString,
 ...
 function OnNew() {
     ...
     $.get("<%= Web.Model.Utility.Get_Path() %>/Store/New/" + id,
            NewStore
            );
    ...
    function OnSave()
    {
         ...
         $.getJSON("<%= Web.Model.Utility.Get_Path() %>/Store/Save", queryString, function(data) {
    ...
    function OnEdit(id) {
     ...
     $.get("<%= Web.Model.Utility.Get_Path() %>/Store/Edit/" + id ,
            EditStore
            );
