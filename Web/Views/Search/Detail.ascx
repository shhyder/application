               ...
               <span class="text-main-products">
                <div>
                    <fieldset>
                        ...
                        <%} %>
                        <%if (!disRow.IsPhone1Null() && disRow.Is_Phone1_Display)
                          {
                              ...
                              <%} %>
                        <%} %>
                         <%if (!disRow.IsPhone2Null() && disRow.Is_Phone2_Display)
                           {
                         ...
                         <%} %>
                        <%} %>
                        <%if (!disRow.IsEmailNull() && disRow.Is_Email1_Display)
                          {
                        ...
                        <div class="editor-field">
                         ...
                         <%} %>
                        <%} %>
                        <%if (!disRow.IsWebsiteNull() && disRow.Is_Website_Display )
                          {
